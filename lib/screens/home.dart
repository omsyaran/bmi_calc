import 'package:dummy/constants/app_constants.dart';
import 'package:dummy/widgets/left_bar.dart';
import 'package:dummy/widgets/right_bar.dart';
        ...
        child:  Column(
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                child: Text("COMPUTE", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color:accentHexColor),),
              ),
            ),
            SizedBox(height: 50,),
            Container(
